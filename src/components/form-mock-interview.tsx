...
//if new interview means it will be create a new mock interview or else it will show the interview which you selected 
    ...
    const cleanAiResponse = (responseText :string)=>{
        ...
        //step1 : trim any surrounding whitespace
