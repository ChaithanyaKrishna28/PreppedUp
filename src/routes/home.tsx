...
// it is a static page bro so add what ever you need because it is homepage ans is displayed to all my >>>>>>

const HomePage = () => {
  return (
    <div className="flex-col w-full pd-24">
      <Container>
      <div className="my-8">
...
{/*  this is the button to start broooooo */}
